...
public class AnnotationMatchingPointcut implements Pointcut {
    ...
    public AnnotationMatchingPointcut(@Nullable Class<? extends Annotation> paramAnnotationType) {

        Assert.isTrue((paramAnnotationType != null),
                "Either Class annotation type or Method annotation type needs to be specified (or both)");
        this.classFilter = ClassFilter.TRUE;
        this.methodMatcher = new AnnotationParamMatcher(paramAnnotationType, true);
    }
